...
### Spatial Analysis
SafeGraph (SG) collected the [location data](https://docs.safegraph.com/docs/social-distancing-metrics) that could be used to track changes in social distancing behavior with timely statistics. The following data visualizations explored some of the impacts the COVID-19 pandemic had on travel patterns in California by using space-time pattern mining tools.
